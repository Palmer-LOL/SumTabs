...
- Toggle **Ignore a tab’s initial URL while grouping and enforcing placement** to avoid grouping or placement enforcement while tabs are still on their initial load.
